...
const CollectBusinessInfoComponent = observer(class CollectBusinessInfoComponent extends Component {
  ...
  async componentWillMount() {
    ...
    } else if(find(userStore.attributes, ['name','website'])) {
      ...
      <div style={styles.pageStyle}>
        <MuiThemeProvider>
          ...
          <div className="col-md-10 col-md-offset-1 center card" style={{backgroundColor:'#DCDCDC', height:'auto', marginTop:'20px', borderRadius:2, minWidth:'300px', minHeight:'300px'}}>
            ...
            <div className="col-md-10 col-md-offset-1" style={{marginBottom:60}}>
          ...
          <div className="col-md-10 col-md-offset-1 center card" style={{backgroundColor:'#DCDCDC', height:'auto', marginTop:'20px',marginBottom:50, borderRadius:2, minWidth:'300px', minHeight:'300px'}}>
            <div className="col-md-4 col-md-offset-1" style={{fontSize:'28px', fontWeight:'bold', marginTop:'65px'}}>
              Where Are You?
            </div>
...
export default CollectBusinessInfoComponent;
